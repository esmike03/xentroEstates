...
<body>
    <div class="container mx-auto p-4">
        <div class="flex item-center mb-4 gap-2">
            <a href="/subdivisions" class="bg-gray-600 text-white p-1 px-2 rounded-md">Back</a>
            <h1 class="text-2xl font-semibold">Create New Subdivision</h1>
        </div>
        ...
        <form action="{{ route('store_subdivision') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="amenities" id="amenities" class="border p-2 w-full"
                    placeholder="e.g., Pool, Clubhouse, Gym">
            </div>
  ...
  <input type="number" name="blocks[${blockCount}][houses][${houseIndex}][house_price]" class="w-full border rounded py-2 px-3" min="0" step="any" min="0" required> --}}
    <script>
        ...
        `;
            ...
            <select name="blocks[${blockCount}][houses][${houseIndex}][category]" class="w-full border rounded py-2 px-3" required>
