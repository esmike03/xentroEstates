...
Route::put('/category/update/{id}', [SubQueryController::class, 'category_update']);
Route::get('/category_sub', [SubQueryController::class, 'category'])->name('admin.category.sub');
Route::post('/category/store', [SubQueryController::class, 'store_cat'])->name('admin.category.store');
Route::delete('/category/delete/{id}', [SubQueryController::class, 'cat_destroy'])->name('category.destroy');
// Logout
...
Route::get('/inqueries/user', function () {
    return view('adinqueries');
});
...
Route::get('/bookings/inquiries', [BookingController::class, 'index'])->name('bookings.index');
